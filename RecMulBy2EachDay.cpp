...
double a_penny_doubled_everyday(int n, double CurrentPrice);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
...
void amount_accumulated() {
    ...
    double total_amount = a_penny_doubled_everyday(1, 0.01);
...
double a_penny_doubled_everyday(int n, double CurrentPrice) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
    ...
    return  a_penny_doubled_everyday(n = n + 1, CurrentPrice = CurrentPrice * 2);
